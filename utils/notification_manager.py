...
class NotificationManager:
    ...
    def _send_email(self, data: Dict) -> bool:
        ...
        try:
            ...
            msg['Subject'] = f"NexScan: {data['title']} - {data['target']}"
            msg['From'] = from_addr
    ...
    def _send_discord_critical(self, data: Dict) -> bool:
        ...
        try:
            ...
            embed = {
                ...
                "footer": {"text": "NexScan Scanner - Immediate Alert"}
            }
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p style="margin-top: 20px; font-size: 12px; color: #7f8c8d;">
                        This is an automated notification from NexScan Scanner.
                    </p>
                </div>
            </div>
        </body>
