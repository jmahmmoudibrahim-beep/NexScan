...
class ReportGenerator:
    ...
    def _generate_json(self, results: Dict, output_path: str):
        ...
        report_data = {
            'report_meta': {
                'tool': 'NexScan - Advanced AI-Driven Penetration Testing Tool',
                'author': 'Hulk',
    ...
    def _generate_html(self, results: Dict, output_path: str):
        ...
        report_data = {
            'title': 'NexScan Security Assessment Report',
            'generated_date': datetime.now().strftime('%Y-%m-%d %H:%M:%S'),
    ...
    def _generate_pdf(self, results: Dict, output_path: str):
        ...
        try:
            ...
            # Title
            story.append(Paragraph("NexScan Security Assessment Report", title_style))
            ...
            story.append(Paragraph("By Hulk", author_style))
            ...
            story.append(Paragraph("This report was generated by NexScan - Advanced AI-Driven Penetration Testing Tool | By Hulk", footer_style))
            story.append(Paragraph("This report contains sensitive security information. Handle with care.", footer_style))
...
<body>
    <div class="container">
        <div class="header">
            <h1> {{ title }}</h1>
            <p>Generated: {{ generated_date }} | By Hulk</p>
        </div>
        ...
        <div class="footer">
            <p>This report was generated by NexScan - Advanced AI-Driven Penetration Testing Tool | By Hulk</p>
